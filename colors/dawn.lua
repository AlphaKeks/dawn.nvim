...
local Dawn = require("dawn").palette
...
hi("rustEscapeUnicode")

hi("rustMacroVariable")

hi("rustPubScopeCrate")

hi("rustPubScopeDelim")

hi("rustArrowCharacter")

hi("rustCommentLineDoc")

hi("rustCommentBlockDoc")

hi("rustIdentifierPrime")

hi("rustObsoleteStorage")

hi("rustReservedKeyword")

hi("rustCharacterInvalid")

hi("rustMacroRepeatCount")

hi("rustObsoleteExternMod")

hi("rustBoxPlacementParens")

hi("rustInvalidBareKeyword")

hi("rustStringContinuation")

hi("rustCommentLineDocError")

hi("rustCommentBlockDocError")

hi("rustMacroRepeatDelimiters")

hi("rustCharacterInvalidUnicode")
